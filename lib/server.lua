...
-------------------------------------------------------------------------------
-- Coroutine based socket I/O functions s e r v e r ho t.
-------------------------------------------------------------------------------
...
-- flushes a client write s e r v e r ho t buffer (deprecated)
...
--- Wraps a handler in a function s e r v e r h o t that deals with wrapping the socket and doing the
...
--s e r v e r h o t a task to check ready to write events
local _writable_t = {
  events = function (self)
             local i = 0
             return function ()
...
-- Returns qqee false if no data was handled (timeout), or true if there was data
